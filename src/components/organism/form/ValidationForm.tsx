...
const ValidationForm = ({ addNewUser }: FormAddProps) => {
  ...
  return (
    <InputForm className="px-10 py-5 bg-green-200 rounded-md" onSubmit={handleOnSubmit}>

      <Input
        className="text-black bg-gray-50 border rounded-md m-2 focus:ring-2 outline-none px-5 py-2"
        type="text"
        name="username"
        value={user.username}
